<script>
  ...
  import ElButton from 'bs-element-ui/packages/button';
  import ElButtonGroup from 'bs-element-ui/packages/button-group';
  import { generateId } from 'bs-element-ui/src/utils/util';
