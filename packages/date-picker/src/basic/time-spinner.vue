...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'bs-element-ui/src/utils/date-util';
  import ElScrollbar from 'bs-element-ui/packages/scrollbar';
  import RepeatClick from 'bs-element-ui/src/directives/repeat-click';
