...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'bs-element-ui/src/utils/date-util';
  import { hasClass } from 'bs-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'bs-element-ui/src/utils/util';
