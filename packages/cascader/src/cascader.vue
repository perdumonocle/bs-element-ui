...
<script>
import Popper from 'bs-element-ui/src/utils/vue-popper';
import Clickoutside from 'bs-element-ui/src/utils/clickoutside';
import Emitter from 'bs-element-ui/src/mixins/emitter';
import Locale from 'bs-element-ui/src/mixins/locale';
import Migrating from 'bs-element-ui/src/mixins/migrating';
import ElInput from 'bs-element-ui/packages/input';
import ElTag from 'bs-element-ui/packages/tag';
import ElScrollbar from 'bs-element-ui/packages/scrollbar';
import ElCascaderPanel from 'bs-element-ui/packages/cascader-panel';
import AriaUtils from 'bs-element-ui/src/utils/aria-utils';
import { t } from 'bs-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'bs-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'bs-element-ui/src/utils/types';
import { isDef } from 'bs-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'bs-element-ui/src/utils/resize-event';
